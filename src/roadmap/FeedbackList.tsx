    ...
    return (
      ...
      >
        <div className={`flex flex:col `}>
          <li key="key" className="capitalize">{productRequest.status}</li>
          <p>
  ...
  return (
    <div className="flex flex:col jc:center">
      <div className="capitalize">
        {status}
        {" ("}
        {getFeedbackCount(feedbacks, status, category)}
        {")"}
      </div>
      <div>
        {status === "planned"
